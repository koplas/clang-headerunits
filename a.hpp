...
inline float fmod(float __x, float __y) noexcept {
  return __builtin_fmodf(__x, __y);
}

template <class = int> double fmod(double __x, double __y) noexcept {
...
inline float modf(float __x, float *__y) noexcept {
  return __builtin_modff(__x, __y);
}

template <class = int> double modf(double __x, double *__y) noexcept {
...
inline float remainder(float __x, float __y) noexcept {
  return __builtin_remainderf(__x, __y);
}

template <class = int> double remainder(double __x, double __y) noexcept {
...
template <class _A1, class _A2,
          __enable_if_t<is_arithmetic<_A1>::value && is_arithmetic<_A2>::value,
                        int> = 0>
inline typename __promote<_A1, _A2>::type remquo(_A1 __x, _A2 __y,
                                                 int *__z) noexcept {
  using __result_type = typename __promote<_A1, _A2>::type;
  static_assert(!(_IsSame<_A1, __result_type>::value &&
                  _IsSame<_A2, __result_type>::value),
...
[[__nodiscard__]] inline float ceil(float __x) noexcept {
  return __builtin_ceilf(__x);
}

template <class = int> [[__nodiscard__]] double ceil(double __x) noexcept {
...
[[__nodiscard__]] inline float floor(float __x) noexcept {
  return __builtin_floorf(__x);
}

template <class = int> [[__nodiscard__]] double floor(double __x) noexcept {
...
template <class = int> long long llrint(double __x) noexcept {
  return __builtin_llrint(__x);
}

inline long long llrint(long double __x) noexcept {
...
template <class = int> long long llround(double __x) noexcept {
  return __builtin_llround(__x);
}

inline long long llround(long double __x) noexcept {
...
template <class = int> long lrint(double __x) noexcept {
...
template <class = int> long lround(double __x) noexcept {
...
template <class = int> [[__nodiscard__]] double nearbyint(double __x) noexcept {
...
inline float nextafter(float __x, float __y) noexcept {
  return __builtin_nextafterf(__x, __y);
}

template <class = int> double nextafter(double __x, double __y) noexcept {
...
template <class = int> double nexttoward(double __x, long double __y) noexcept {
...
[[__nodiscard__]] inline float rint(float __x) noexcept {
  return __builtin_rintf(__x);
}

template <class = int> [[__nodiscard__]] double rint(double __x) noexcept {
...
[[__nodiscard__]] inline float round(float __x) noexcept {
  return __builtin_round(__x);
}

template <class = int> [[__nodiscard__]] double round(double __x) noexcept {
  return __builtin_round(__x);
}
...
[[__nodiscard__]] inline float trunc(float __x) noexcept {
  return __builtin_trunc(__x);
}

template <class = int> [[__nodiscard__]] double trunc(double __x) noexcept {
  return __builtin_trunc(__x);
}
...
template <class = int> double cos(double __x) noexcept {
...
template <class = int> double sin(double __x) noexcept {
...
template <class = int> double tan(double __x) noexcept {
...
swap(__tuple_leaf<_Ip, _Hp, _Ep> &__x,
     __tuple_leaf<_Ip, _Hp, _Ep> &__y) noexcept(__is_nothrow_swappable_v<_Hp>) {
  swap(__x.get(), __y.get());
}

template <size_t _Ip, class _Hp, bool _Ep>
constexpr void swap(const __tuple_leaf<_Ip, _Hp, _Ep> &__x,
                    const __tuple_leaf<_Ip, _Hp, _Ep>
                        &__y) noexcept(__is_nothrow_swappable_v<const _Hp>) {
  swap(__x.get(), __y.get());
}
...
public:
  ...
  constexpr __tuple_leaf() noexcept(
  ...
  template <class _Alloc>
  constexpr __tuple_leaf(integral_constant<int, 2>, const _Alloc &__a)
      : __value_(__a) {}

  template <class _Tp,
            __enable_if_t<_And<_IsNotSame<__remove_cvref_t<_Tp>, __tuple_leaf>,
                               is_constructible<_Hp, _Tp>>::value,
                          int> = 0>

  constexpr explicit __tuple_leaf(_Tp &&__t) noexcept(
      is_nothrow_constructible<_Hp, _Tp>::value)
      : __value_(std::forward<_Tp>(__t)) {}

  template <class _Tp, class _Alloc>

  constexpr explicit __tuple_leaf(integral_constant<int, 0>, const _Alloc &,
                                  _Tp &&__t)
      : __value_(std::forward<_Tp>(__t)) {}

  template <class _Tp, class _Alloc>

  constexpr explicit __tuple_leaf(integral_constant<int, 1>, const _Alloc &__a,
                                  _Tp &&__t)
      : __value_(allocator_arg_t(), __a, std::forward<_Tp>(__t)) {}

  template <class _Tp, class _Alloc>

  constexpr explicit __tuple_leaf(integral_constant<int, 2>, const _Alloc &__a,
                                  _Tp &&__t)
...
template <class... _Tp> constexpr void __swallow(_Tp &&...) noexcept {}
...
struct __tuple_impl<__tuple_indices<_Indx...>, _Tp...>
  ...
  template <class _Alloc, size_t... _Uf, class... _Tf, size_t... _Ul,
            class... _Tl, class... _Up>
  constexpr explicit __tuple_impl(allocator_arg_t, const _Alloc &__a,
                                  __tuple_indices<_Uf...>,
                                  __tuple_types<_Tf...>,
                                  __tuple_indices<_Ul...>,
  ...
  constexpr void swap(__tuple_impl &__t) noexcept(
      __all<__is_nothrow_swappable_v<_Tp>...>::value) {
    std::__swallow(__tuple_leaf<_Indx, _Tp>::swap(
  ...
  constexpr void swap(const __tuple_impl &__t) const
    ...
    std::__swallow(__tuple_leaf<_Indx, _Tp>::swap(
        static_cast<const __tuple_leaf<_Indx, _Tp> &>(__t))...);
  }
};

template <class _Dest, class _Source, size_t... _Np>
constexpr void __memberwise_copy_assign(_Dest &__dest, _Source const &__source,
                                        __tuple_indices<_Np...>) {
  std::__swallow(
      ((std::get<_Np>(__dest) = std::get<_Np>(__source)), void(), 0)...);
}

template <class _Dest, class _Source, class... _Up, size_t... _Np>
constexpr void __memberwise_forward_assign(_Dest &__dest, _Source &&__source,
                                           __tuple_types<_Up...>,
                                           __tuple_indices<_Np...>) {
  std::__swallow(
...
public:
  using __trivially_relocatable [[__gnu__::__nodebug__]] =
      __conditional_t<_And<__libcpp_is_trivially_relocatable<_Tp>...>::value,
                      tuple, void>;

  template <template <class...>
            class _IsImpDefault = __is_implicitly_default_constructible,
  ...
  template <template <class...> class _And = _And,
            __enable_if_t<_And<_BoolConstant<sizeof...(_Tp) >= 1>,
                               is_copy_constructible<_Tp>...>::value,
                          int> = 0>
  ...
  constexpr explicit(
      ...
      tuple(const _Tp &...__t) noexcept(
          _And<is_nothrow_copy_constructible<_Tp>...>::value)
      : __base_(typename __make_tuple_indices<sizeof...(_Tp)>::type(),
                typename __make_tuple_types<tuple, sizeof...(_Tp)>::type(),
                typename __make_tuple_indices<0>::type(),
                typename __make_tuple_types<tuple, 0>::type(), __t...) {}

  template <class _Alloc, template <class...> class _And = _And,
            __enable_if_t<_And<_BoolConstant<sizeof...(_Tp) >= 1>,
                               is_copy_constructible<_Tp>...>::value,
                          int> = 0>
  ...
  struct _EnableUTypesCtor
      : _And<_BoolConstant<sizeof...(_Tp) >= 1>, _Not<_IsThisTuple<_Up...>>,
             is_constructible<_Tp, _Up>...> {};

  template <class... _Up,
            __enable_if_t<_And<_BoolConstant<sizeof...(_Up) == sizeof...(_Tp)>,
                               _EnableUTypesCtor<_Up...>>::value,
                          int> = 0>
  constexpr explicit(_Not<_Lazy<_And, is_convertible<_Up, _Tp>...>>::value)
      tuple(_Up &&...__u) noexcept(
          _And<is_nothrow_constructible<_Tp, _Up>...>::value)
  ...
  struct _EnableCtorFromUTypesTuple<
      ...
      : _And<
            ...
            _Lazy<_Or, _BoolConstant<sizeof...(_Tp) != 1>,
                  ...
                  _Lazy<_And, _Not<is_same<_Tp, _Up>>...,
                        _Not<is_convertible<_OtherTuple, _Tp>>...,
                        _Not<is_constructible<_Tp, _OtherTuple>>...>>> {};

  template <class... _Up,
            __enable_if_t<
                _And<_EnableCtorFromUTypesTuple<const tuple<_Up...> &>>::value,
                int> = 0>

  constexpr explicit(
      _Not<_Lazy<_And, is_convertible<const _Up &, _Tp>...>>::value)
      tuple(const tuple<_Up...> &__t) noexcept(
          _And<is_nothrow_constructible<_Tp, const _Up &>...>::value)
      : __base_(__t) {}
  ...
  template <
      class... _Up,
      __enable_if_t<_And<_EnableCtorFromUTypesTuple<tuple<_Up...> &&>>::value,
                    int> = 0>
  constexpr explicit(_Not<_Lazy<_And, is_convertible<_Up, _Tp>...>>::value)
      tuple(tuple<_Up...> &&__t) noexcept(
          _And<is_nothrow_constructible<_Tp, _Up>...>::value)
      : __base_(std::move(__t)) {}

  template <
      class _Alloc, class... _Up,
      __enable_if_t<_And<_EnableCtorFromUTypesTuple<tuple<_Up...> &&>>::value,
                    int> = 0>
  explicit(_Not<_Lazy<_And, is_convertible<_Up, _Tp>...>>::value)
      tuple(allocator_arg_t, const _Alloc &__a, tuple<_Up...> &&__t)
      : __base_(allocator_arg_t(), __a, std::move(__t)) {}
  template <template <class...> class _Pred, class _Pair,
            class _DecayedPair = __remove_cvref_t<_Pair>, class _Tuple = tuple>
  struct _CtorPredicateFromPair : false_type {};

  template <template <class...> class _Pred, class _Pair, class _Up1,
            class _Up2, class _Tp1, class _Tp2>
  struct _CtorPredicateFromPair<_Pred, _Pair, pair<_Up1, _Up2>,
                                tuple<_Tp1, _Tp2>>
      : _And<_Pred<_Tp1, __copy_cvref_t<_Pair, _Up1>>,
  ...
  template <class _Pair>
  struct _NothrowConstructibleFromPair
      : _CtorPredicateFromPair<is_nothrow_constructible, _Pair> {};

  template <class _Pair, class _DecayedPair = __remove_cvref_t<_Pair>,
            class _Tuple = tuple>
  ...
  struct _BothImplicitlyConvertible<_Pair, pair<_Up1, _Up2>, tuple<_Tp1, _Tp2>>
      : _And<is_convertible<__copy_cvref_t<_Pair, _Up1>, _Tp1>,
             is_convertible<__copy_cvref_t<_Pair, _Up2>, _Tp2>> {};

  template <
      class _Up1, class _Up2, template <class...> class _And = _And,
      __enable_if_t<_And<_EnableCtorFromPair<const pair<_Up1, _Up2> &>>::value,
                    int> = 0>

  constexpr explicit(
      _Not<_BothImplicitlyConvertible<const pair<_Up1, _Up2> &>>::value)
      tuple(const pair<_Up1, _Up2> &__p) noexcept(
          _NothrowConstructibleFromPair<const pair<_Up1, _Up2> &>::value)
      : __base_(__p) {}

  template <
      class _Alloc, class _Up1, class _Up2,
  ...
  template <class _Up1, class _Up2, template <class...> class _And = _And,
            __enable_if_t<_And<_EnableCtorFromPair<pair<_Up1, _Up2> &&>>::value,
                          int> = 0>

  constexpr explicit(
      _Not<_BothImplicitlyConvertible<pair<_Up1, _Up2> &&>>::value)
      tuple(pair<_Up1, _Up2> &&__p) noexcept(
          _NothrowConstructibleFromPair<pair<_Up1, _Up2> &&>::value)
  ...
  tuple &operator=(
      _If<_And<is_copy_assignable<_Tp>...>::value, tuple, __nat> const
          &__tuple) noexcept(_And<is_nothrow_copy_assignable<_Tp>...>::value) {
    std::__memberwise_copy_assign(
        *this, __tuple, typename __make_tuple_indices<sizeof...(_Tp)>::type());
    return *this;
  }
  tuple &operator=(
      _If<_And<is_move_assignable<_Tp>...>::value, tuple, __nat>
          &&__tuple) noexcept(_And<is_nothrow_move_assignable<_Tp>...>::value) {
    std::__memberwise_forward_assign(
        *this, std::move(__tuple), __tuple_types<_Tp...>(),
        typename __make_tuple_indices<sizeof...(_Tp)>::type());
    return *this;
  }

  template <class... _Up,
            __enable_if_t<_And<_BoolConstant<sizeof...(_Tp) == sizeof...(_Up)>,
                               is_assignable<_Tp &, _Up const &>...>::value,
                          int> = 0>
  tuple &operator=(tuple<_Up...> const &__tuple) noexcept(
      _And<is_nothrow_assignable<_Tp &, _Up const &>...>::value) {
    std::__memberwise_copy_assign(
        *this, __tuple, typename __make_tuple_indices<sizeof...(_Tp)>::type());
    return *this;
  }
  ...
  template <class... _Up,
            __enable_if_t<_And<_BoolConstant<sizeof...(_Tp) == sizeof...(_Up)>,
                               is_assignable<_Tp &, _Up>...>::value,
                          int> = 0>
  tuple &operator=(tuple<_Up...> &&__tuple) noexcept(
      _And<is_nothrow_assignable<_Tp &, _Up>...>::value) {
    std::__memberwise_forward_assign(
        *this, std::move(__tuple), __tuple_types<_Up...>(),
        typename __make_tuple_indices<sizeof...(_Tp)>::type());
    return *this;
  }
  template <template <class...> class _Pred, bool _Const, class _Pair,
            class _DecayedPair = __remove_cvref_t<_Pair>, class _Tuple = tuple>
  struct _AssignPredicateFromPair : false_type {};

  template <template <class...> class _Pred, bool _Const, class _Pair,
            class _Up1, class _Up2, class _Tp1, class _Tp2>
  struct _AssignPredicateFromPair<_Pred, _Const, _Pair, pair<_Up1, _Up2>,
                                  tuple<_Tp1, _Tp2>>
      : _And<
            _Pred<__maybe_const<_Const, _Tp1> &, __copy_cvref_t<_Pair, _Up1>>,
  ...
  template <class _Up1, class _Up2,
            __enable_if_t<
                ...
                int> = 0>
  tuple &operator=(pair<_Up1, _Up2> const &__pair) noexcept(
      _NothrowAssignFromPair<false, pair<_Up1, _Up2> const &>::value) {
  ...
  template <
      class _Up1, class _Up2,
      __enable_if_t<_EnableAssignFromPair<false, pair<_Up1, _Up2> &&>::value,
                    int> = 0>
  tuple &operator=(pair<_Up1, _Up2> &&__pair) noexcept(
      _NothrowAssignFromPair<false, pair<_Up1, _Up2> &&>::value) {
  ...
  template <class _Up, size_t _Np,
            __enable_if_t<_And<_BoolConstant<_Np == sizeof...(_Tp)>,
                               is_assignable<_Tp &, _Up const &>...>::value,
                          int> = 0>
  tuple &operator=(array<_Up, _Np> const &__array) noexcept(
      _And<is_nothrow_assignable<_Tp &, _Up const &>...>::value) {
    std::__memberwise_copy_assign(
        *this, __array, typename __make_tuple_indices<sizeof...(_Tp)>::type());
    return *this;
  }

  template <class _Up, size_t _Np, class = void,
            __enable_if_t<_And<_BoolConstant<_Np == sizeof...(_Tp)>,
                               is_assignable<_Tp &, _Up>...>::value,
                          int> = 0>
  tuple &operator=(array<_Up, _Np> &&__array) noexcept(
      _And<is_nothrow_assignable<_Tp &, _Up>...>::value) {
    std::__memberwise_forward_assign(
        *this, std::move(__array), __tuple_types<_If<true, _Up, _Tp>...>(),
        typename __make_tuple_indices<sizeof...(_Tp)>::type());
    return *this;
  }
...
public:
  ...
  template <class _Up> tuple(array<_Up, 0>) noexcept {}
  template <class _Alloc, class _Up>
  tuple(allocator_arg_t, const _Alloc &, array<_Up, 0>) noexcept {}
  void swap(tuple &) noexcept {}
};
#pragma clang diagnostic pop
template <class... _Tp> tuple(_Tp...) -> tuple<_Tp...>;
template <class _Tp1, class _Tp2> tuple(pair<_Tp1, _Tp2>) -> tuple<_Tp1, _Tp2>;
template <class _Alloc, class... _Tp>
...
template <class... _Tp,
          __enable_if_t<__all<__is_swappable_v<_Tp>...>::value, int> = 0>
inline void swap(tuple<_Tp...> &__t, tuple<_Tp...> &__u) noexcept(
    __all<__is_nothrow_swappable_v<_Tp>...>::value) {
  __t.swap(__u);
}
template <size_t _Ip, class... _Tp>
...
template <class... _Tp>
inline constexpr tuple<__unwrap_ref_decay_t<_Tp>...> make_tuple(_Tp &&...__t) {
...
template <size_t _Ip> struct __tuple_equal {
  ...
  constexpr bool operator()(const _Tp &__x, const _Up &__y) {
    return __tuple_equal<_Ip - 1>()(__x, __y) &&
           std::get<_Ip - 1>(__x) == std::get<_Ip - 1>(__y);
  }
};
...
template <class... _Tp, class... _Up>
inline constexpr bool operator<(const tuple<_Tp...> &__x,
                                const tuple<_Up...> &__y) {
...
struct __tuple_cat_return_1<tuple<_Types...>, true, _Tuple0> {
  using type [[__gnu__::__nodebug__]] = typename __tuple_cat_type<
      tuple<_Types...>,
...
struct __tuple_cat_return_ref_imp<tuple<_Types...>, __tuple_indices<_I0...>,
  ...
  typedef tuple<
      _Types...,
      __copy_cvref_t<_Tuple0, typename tuple_element<_I0, _T0>::type> &&...>
      type;
};
...
struct __tuple_cat_return_ref_imp<tuple<_Types...>, __tuple_indices<_I0...>,
    ...
    : public __tuple_cat_return_ref_imp<
          tuple<_Types...,
                __copy_cvref_t<_Tuple0, typename tuple_element<
                                            _I0, __libcpp_remove_reference_t<
                                                     _Tuple0>>::type> &&...>,
          typename __make_tuple_indices<
              tuple_size<__libcpp_remove_reference_t<_Tuple1>>::value>::type,
          _Tuple1, _Tuples...> {};
...
struct __tuple_cat_return_ref
    : public __tuple_cat_return_ref_imp<
          tuple<>,
          typename __make_tuple_indices<
              tuple_size<__libcpp_remove_reference_t<_Tuple0>>::value>::type,
          _Tuple0, _Tuples...> {};
...
struct __tuple_cat<tuple<_Types...>, __tuple_indices<_I0...>,
  ...
  constexpr
    ...
    (void)__t;
    return std::forward_as_tuple(std::forward<_Types>(std::get<_I0>(__t))...,
                                 std::get<_J0>(std::forward<_Tuple0>(__t0))...);
  }

  template <class _Tuple0, class _Tuple1, class... _Tuples>
  constexpr typename __tuple_cat_return_ref<tuple<_Types...> &&, _Tuple0 &&,
  ...
  operator()(tuple<_Types...> __t, _Tuple0 &&__t0, _Tuple1 &&__t1,
    ...
    return __tuple_cat<
        tuple<_Types..., __copy_cvref_t<_Tuple0, typename tuple_element<
                                                     _J0, _T0>::type> &&...>,
        typename __make_tuple_indices<sizeof...(_Types) +
                                      tuple_size<_T0>::value>::type,
        typename __make_tuple_indices<tuple_size<_T1>::value>::type>()(
        std::forward_as_tuple(std::forward<_Types>(std::get<_I0>(__t))...,
                              std::get<_J0>(std::forward<_Tuple0>(__t0))...),
...
__tuple_cat_select_element_wise(_TupleSrc &&__src,
...
tuple_cat(_Tuple0 &&__t0, _Tuples &&...__tpls) {
  using _T0 [[__gnu__::__nodebug__]] = __libcpp_remove_reference_t<_Tuple0>;
  using _TRet [[__gnu__::__nodebug__]] =
      typename __tuple_cat_return<_Tuple0, _Tuples...>::type;
  using _T0Indices [[__gnu__::__nodebug__]] =
      typename __make_tuple_indices<tuple_size<_T0>::value>::type;
  using _TRetIndices [[__gnu__::__nodebug__]] =
      typename __make_tuple_indices<tuple_size<_TRet>::value>::type;
...
__apply_tuple_impl(_Fn &&__f, _Tuple &&__t, __tuple_indices<_Id...>) noexcept(
    noexcept(std::__invoke(std::forward<_Fn>(__f),
...
inline constexpr decltype(auto)
apply(_Fn &&__f, _Tuple &&__t) noexcept(noexcept(std::__apply_tuple_impl(
    std::forward<_Fn>(__f), std::forward<_Tuple>(__t),
    typename __make_tuple_indices<
        tuple_size_v<remove_reference_t<_Tuple>>>::type{}))) {
  return std::__apply_tuple_impl(
      std::forward<_Fn>(__f), std::forward<_Tuple>(__t),
      typename __make_tuple_indices<
          tuple_size_v<remove_reference_t<_Tuple>>>::type{});
}
template <class _Tp, class _Tuple, size_t... _Idx>
inline constexpr _Tp __make_from_tuple_impl(
    _Tuple &&__t, __tuple_indices<_Idx...>,
    enable_if_t<is_constructible_v<
        _Tp, decltype(std::get<_Idx>(std::forward<_Tuple>(__t)))...>> * =
        nullptr) noexcept(noexcept(_Tp(std::
                                           get<_Idx>(std::forward<_Tuple>(
                                               __t))...))) {
  return _Tp(std::get<_Idx>(std::forward<_Tuple>(__t))...);
}

template <class _Tp, class _Tuple,
          class _Seq = typename __make_tuple_indices<
              tuple_size_v<remove_reference_t<_Tuple>>>::type,
          class = void>
...
inline constexpr bool __can_make_from_tuple<
    _Tp, _Tuple, __tuple_indices<_Idx...>,
    enable_if_t<is_constructible_v<_Tp, decltype(std::get<_Idx>(
                                            std::declval<_Tuple>()))...>>> =
    true;
template <class _Tp, class _Tuple,
          class = enable_if_t<__can_make_from_tuple<_Tp, _Tuple>>>

inline constexpr _Tp make_from_tuple(_Tuple &&__t) noexcept(
    noexcept(std::__make_from_tuple_impl<_Tp>(
...
namespace std {
inline namespace __1 {
[[__noreturn__]] inline void __throw_bad_cast() { throw bad_cast(); }
} // namespace __1
} // namespace std
#pragma clang diagnostic pop
...
__cxa_exception *__cxa_init_primary_exception(void *, std::type_info *,
...
class exception_ptr {
  ...
  template <class _Ep> friend exception_ptr make_exception_ptr(_Ep) noexcept;
...
public:
  ...
  friend bool operator==(const exception_ptr &__x,
...
template <class _Tp> [[__noreturn__]] void throw_with_nested(_Tp &&__t) {
...
template <
    class _Ep,
    __enable_if_t<__can_dynamic_cast<_Ep, nested_exception>::value, int> = 0>
inline void rethrow_if_nested(const _Ep &__e) {
  const nested_exception *__nep =
      dynamic_cast<const nested_exception *>(std::addressof(__e));
  if (__nep)
...
template <class _CharT, class _Traits>
class __attribute__((__preferred_name__(filebuf)))
__attribute__((__preferred_name__(wfilebuf))) basic_filebuf;
template <class _CharT, class _Traits>
class __attribute__((__preferred_name__(ifstream)))
__attribute__((__preferred_name__(wifstream))) basic_ifstream;
template <class _CharT, class _Traits>
class __attribute__((__preferred_name__(ofstream)))
__attribute__((__preferred_name__(wofstream))) basic_ofstream;
template <class _CharT, class _Traits>
class __attribute__((__preferred_name__(fstream)))
__attribute__((__preferred_name__(wfstream))) basic_fstream;
...
template <> struct char_traits<char> {
  ...
  static inline constexpr void assign(char_type &__c1,
                                      const char_type &__c2) noexcept {
    __c1 = __c2;
  }

  static inline __attribute__((__visibility__("hidden"))) constexpr bool
...
template <class _CharT, class _IntT, _IntT _EOFVal> struct __char_traits_base {
  using char_type = _CharT;
  using int_type = _IntT;
  using off_type = streamoff;
  using state_type = mbstate_t;

  static inline constexpr void assign(char_type &__lhs,
                                      const char_type &__rhs) noexcept {
    __lhs = __rhs;
  }
  ...
  static char_type *move(char_type *__dest, const char_type *__src,
                         size_t __n) noexcept {
    return std::__constexpr_memmove(__dest, __src, __element_count(__n));
  }

  static char_type *copy(char_type *__dest, const char_type *__src,
                         size_t __n) noexcept {
    ((void)0);
  ...
  static char_type *assign(char_type *__str, size_t __n,
                           char_type __fill_char) noexcept {
    return __str;
  }
...
struct char_traits<wchar_t>
    : __char_traits_base<wchar_t, wint_t, static_cast<wint_t>((0xffffffffu))> {
...
inline constexpr int char_traits<char16_t>::compare(const char_type *__s1,
...
inline constexpr int char_traits<char32_t>::compare(const char_type *__s1,
                                                    const char_type *__s2,
                                                    size_t __n) noexcept {
  for (; __n; --__n, ++__s1, ++__s2) {
    if (lt(*__s1, *__s2))
...
inline _SizeT constexpr __str_find(const _CharT *__p, _SizeT __sz, _CharT __c,
...
template <class _CharT, class _SizeT, class _Traits, _SizeT __npos>
inline _SizeT constexpr __str_find(const _CharT *__p, _SizeT __sz,
...
template <class _CharT, class _SizeT, class _Traits, _SizeT __npos>
inline _SizeT constexpr __str_rfind(const _CharT *__p, _SizeT __sz, _CharT __c,
                                    _SizeT __pos) noexcept {
  return 0;
}

template <class _CharT, class _SizeT, class _Traits, _SizeT __npos>
inline _SizeT constexpr __str_rfind(const _CharT *__p, _SizeT __sz,
                                    const _CharT *__s, _SizeT __pos,
                                    _SizeT __n) noexcept {}

template <class _CharT, class _SizeT, class _Traits, _SizeT __npos>
inline _SizeT constexpr __str_find_first_of(const _CharT *__p, _SizeT __sz,
                                            const _CharT *__s, _SizeT __pos,
                                            _SizeT __n) noexcept {
...
template <class _CharT, class _SizeT, class _Traits, _SizeT __npos>
inline _SizeT constexpr __str_find_last_of(const _CharT *__p, _SizeT __sz,
                                           const _CharT *__s, _SizeT __pos,
                                           _SizeT __n) noexcept {
  if (__n != 0) {
    if (__pos < __sz)
...
template <class _CharT, class _SizeT, class _Traits, _SizeT __npos>
inline _SizeT constexpr __str_find_first_not_of(const _CharT *__p, _SizeT __sz,
                                                const _CharT *__s, _SizeT __pos,
                                                _SizeT __n) noexcept {
  if (__pos < __sz) {
...
template <class _CharT, class _SizeT, class _Traits, _SizeT __npos>
inline _SizeT constexpr __str_find_last_not_of(const _CharT *__p, _SizeT __sz,
                                               const _CharT *__s, _SizeT __pos,
                                               _SizeT __n) noexcept {
  if (__pos < __sz)
    ++__pos;
...
template <class _Ptr> inline size_t __do_string_hash(_Ptr __p, _Ptr __e) {
...
basic_string<char>::rfind(value_type const *, size_type, size_type) const;
...
extern template basic_string<char>::size_type
basic_string<char>::find_last_not_of(value_type const *, size_type,
                                     size_type) const;
extern template basic_string<char>::~basic_string();
extern template basic_string<char>::size_type
basic_string<char>::find_first_not_of(value_type const *, size_type,
                                      size_type) const;
extern template basic_string<char> &
    basic_string<char>::insert(size_type, size_type, value_type);
extern template basic_string<char> &basic_string<char>::operator=(value_type);
extern template void basic_string<char>::__init(value_type const *, size_type);
extern template const char &basic_string<char>::at(size_type) const;
extern template basic_string<char> &
basic_string<char>::insert(size_type, value_type const *, size_type);
extern template basic_string<char>::size_type
...
extern template basic_string<char> &
basic_string<char>::assign(value_type const *, size_type);
extern template void basic_string<char>::reserve(size_type);
extern template basic_string<char> &
basic_string<char>::append(value_type const *, size_type);
extern template basic_string<char> &
basic_string<char>::assign(basic_string const &, size_type, size_type);
extern template basic_string<char>::size_type
...
extern template void basic_string<char>::__init(size_type, value_type);
extern template basic_string<char> &
basic_string<char>::insert(size_type, value_type const *);
extern template basic_string<char>::size_type
basic_string<char>::find_last_of(value_type const *, size_type,
                                 size_type) const;
extern template void basic_string<char>::__grow_by(size_type, size_type,
                                                   size_type, size_type,
                                                   size_type, size_type);
...
basic_string<char>::__grow_by_and_replace(size_type, size_type, size_type,
                                          ...
                                          value_type const *);
extern template void basic_string<char>::push_back(value_type);
extern template basic_string<char> &basic_string<char>::append(size_type,
                                                               value_type);
extern template basic_string<char>::size_type
    basic_string<char>::rfind(value_type, size_type) const;
extern template const basic_string<char>::size_type basic_string<char>::npos;
extern template basic_string<char> &basic_string<char>::assign(size_type,
                                                               value_type);
extern template basic_string<char> &basic_string<char>::erase(size_type,
                                                              size_type);
extern template basic_string<char> &
basic_string<char>::append(basic_string const &, size_type, size_type);
extern template int basic_string<char>::compare(value_type const *) const;
extern template int basic_string<char>::compare(size_type, size_type,
                                                value_type const *) const;
extern template char &basic_string<char>::at(size_type);
extern template basic_string<char> &
basic_string<char>::assign(value_type const *);
extern template basic_string<char>::size_type
basic_string<char>::find(value_type const *, size_type, size_type) const;
extern template int basic_string<char>::compare(size_type, size_type,
...
extern template basic_string<char> &
basic_string<char>::append(value_type const *);
extern template basic_string<char> &
basic_string<char>::replace(size_type, size_type, basic_string const &,
                            size_type, size_type);
extern template basic_string<char>::iterator
    basic_string<char>::insert(basic_string::const_iterator, value_type);
extern template void basic_string<char>::resize(size_type, value_type);
extern template basic_string<char> &
basic_string<char>::insert(size_type, basic_string const &, size_type,
                           size_type);

extern template basic_string<wchar_t> &
basic_string<wchar_t>::replace(size_type, size_type, value_type const *,
                               size_type);
extern template basic_string<wchar_t>::size_type
basic_string<wchar_t>::rfind(value_type const *, size_type, size_type) const;
extern template basic_string<wchar_t>::basic_string(basic_string const &);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::replace(size_type, size_type, value_type const *);
extern template basic_string<wchar_t>::basic_string(basic_string const &,
                                                    allocator<wchar_t> const &);
extern template basic_string<wchar_t>::size_type
basic_string<wchar_t>::find_last_not_of(value_type const *, size_type,
                                        size_type) const;
extern template basic_string<wchar_t>::~basic_string();
extern template basic_string<wchar_t>::size_type
basic_string<wchar_t>::find_first_not_of(value_type const *, size_type,
                                         size_type) const;
extern template basic_string<wchar_t> &
    basic_string<wchar_t>::insert(size_type, size_type, value_type);
extern template basic_string<wchar_t> &
    basic_string<wchar_t>::operator=(value_type);
extern template void basic_string<wchar_t>::__init(value_type const *,
                                                   size_type);
extern template const wchar_t &basic_string<wchar_t>::at(size_type) const;
extern template basic_string<wchar_t> &
basic_string<wchar_t>::insert(size_type, value_type const *, size_type);
extern template basic_string<wchar_t>::size_type
basic_string<wchar_t>::find_first_of(value_type const *, size_type,
                                     size_type) const;
extern template basic_string<wchar_t> &
    basic_string<wchar_t>::replace(size_type, size_type, size_type, value_type);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::assign(value_type const *, size_type);
extern template void basic_string<wchar_t>::reserve(size_type);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::append(value_type const *, size_type);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::assign(basic_string const &, size_type, size_type);
extern template basic_string<wchar_t>::size_type
...
extern template void basic_string<wchar_t>::__init(size_type, value_type);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::insert(size_type, value_type const *);
extern template basic_string<wchar_t>::size_type
basic_string<wchar_t>::find_last_of(value_type const *, size_type,
                                    size_type) const;
extern template void basic_string<wchar_t>::__grow_by(size_type, size_type,
                                                      size_type, size_type,
                                                      size_type, size_type);
extern template void
basic_string<wchar_t>::__grow_by_and_replace(size_type, size_type, size_type,
                                             size_type, size_type, size_type,
                                             value_type const *);
extern template void basic_string<wchar_t>::push_back(value_type);
extern template basic_string<wchar_t> &
    basic_string<wchar_t>::append(size_type, value_type);
extern template basic_string<wchar_t>::size_type
    basic_string<wchar_t>::rfind(value_type, size_type) const;
extern template const basic_string<wchar_t>::size_type
    basic_string<wchar_t>::npos;
extern template basic_string<wchar_t> &
    basic_string<wchar_t>::assign(size_type, value_type);
extern template basic_string<wchar_t> &basic_string<wchar_t>::erase(size_type,
                                                                    size_type);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::append(basic_string const &, size_type, size_type);
extern template int basic_string<wchar_t>::compare(value_type const *) const;
extern template int basic_string<wchar_t>::compare(size_type, size_type,
                                                   value_type const *) const;
extern template wchar_t &basic_string<wchar_t>::at(size_type);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::assign(value_type const *);
extern template basic_string<wchar_t>::size_type
basic_string<wchar_t>::find(value_type const *, size_type, size_type) const;
extern template int basic_string<wchar_t>::compare(size_type, size_type,
                                                   basic_string const &,
...
extern template basic_string<wchar_t> &
basic_string<wchar_t>::append(value_type const *);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::replace(size_type, size_type, basic_string const &,
                               size_type, size_type);
extern template basic_string<wchar_t>::iterator
    basic_string<wchar_t>::insert(basic_string::const_iterator, value_type);
extern template void basic_string<wchar_t>::resize(size_type, value_type);
extern template basic_string<wchar_t> &
basic_string<wchar_t>::insert(size_type, basic_string const &, size_type,
                              size_type);
